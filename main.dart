...
class Jokenpo extends StatefulWidget {
  Jokenpo({Key? key}) : super(key: key);

  @override
  State<Jokenpo> createState() => _Jokenpo();
}

class _Jokenpo extends State<Jokenpo> {
    String _imgUserPlayer ="lib/Image/indefinido.png";
    String _imgAppPlayer = "lib/Image/indefinido.png";
    ...
    switch (escolhaUser) {
      ...
      setState(() {
        _imgUserPlayer = "lib/Image/$opcao.png";
      });

      String escolhaApp = _obtemEscolhaApp();
      setState(() {
        _imgAppPlayer = "lib/Image/$escolhaApp.png";
      });
